          ...
          <div class="x_content">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
               <form id="user-form" class="form-horizontal" method="post"  action="@if(!empty($data) && isset($data)){{route('brands.store',$data->id)}}@else{{route('brands.store')}}@endif" enctype="multipart/form-data">
                  ...
                  <fieldset>
                     <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                           <div class="x_panel">
                            <div class="x_title">
                                 <h2>@if(isset($data)){{'Edit Brand'}}@else{{'Add Brand'}}@endif</h2>
                              ...
                              <div class="clearfix"></div>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="item form-group col-12">
                                       <label class="col-form-label col-md-3 col-sm-3 label-align">Brand Image<span class="red">*</span></label>
                     ...
                     <fieldset>
                        <div class="form-group row">
                              <div class="col-md-7 col-sm-7 offset-md-5">
                                 <a href="{{route('brands.index')}}" class="btn btn-warning">Discard</a>
