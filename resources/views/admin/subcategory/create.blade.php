          ...
          <div class="x_content">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
               <form id="user-form" class="form-horizontal" method="Post"  action="@if(!empty($data) && isset($data)){{route('subcategories.store',$data->id)}}@else{{route('subcategories.store')}}@endif" enctype="multipart/form-data">
                  ...
                  <fieldset>
                     <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                           <div class="x_panel">
                            <div class="x_title">
                                 <h2>@if(isset($data)){{'Edit SubCategory'}}@else{{'Add SubCategory'}}@endif</h2>
                              ...
                              <div class="clearfix"></div>
                                ...
                                <div class="x_content">
                                       ...
                                       <div class="col-sm-6 col-sm-3">
                                          <select name="parent_id" class="form-control form-control-m">
                                             ...
                                             @forelse ($category as $list)
                                                 <option value="{{ $list->id }}" {{ isset($data) && $data->parent_id == $list->id ? 'selected' : '' }}>
                                                     {{ $list->name }}
                                                 </option>
                                             @empty
                                    ...
                                    <div class="item form-group col-12">
                                       <label class="col-form-label col-md-3 col-sm-3 label-align">SubCategory Image<span class="red">*</span></label>
                     ...
                     <fieldset>
                        <div class="form-group row">
                              <div class="col-md-7 col-sm-7 offset-md-5">
                                 <a href="{{route('suitable.create')}}" class="btn btn-warning">Discard</a>
