          ...
          <div class="x_content">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
               <form id="faqs-form" class="form-horizontal" method="post"  action="@if(isset($data)){{route('admin.faqs.update',$data->id)}}@else{{route('admin.faqs.store')}}@endif">
                              ...
                              <div class="x_title">
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                          <label class="col-form-label label-align">Question <span class="red">*</span> </label>
                                    ...
                                    <div class="item form-group">
                                        ...
                                        <div class="col-md-12 col-sm-12">
                                          <label class="col-form-label label-align">Answer<span class="red">*</span></label>
