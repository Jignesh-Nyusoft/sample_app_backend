                  ...
                  <fieldset>
                     <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                           <div class="x_panel">
                            <div class="x_title">
                                 <h2>@if(isset($data)){{'Edit Color'}}@else{{'Add Color'}}@endif</h2>
                              ...
                              <div class="clearfix"></div>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align ">Color Name<span class="red">*</span> </label>
                                        <div class="col-md-6 col-sm-6  ">
                                            <input class="form-control" type="text" value="@if(isset($data->name)){{$data->name}}@endif" placeholder="Color Name" name="color_name">
                                       ...
                                       <div class="item form-group">
                                       <label class="col-form-label col-md-3 col-sm-3 label-align ">Select Color<span class="red">*</span> </label>
                                       <div class="col-md-6 col-sm-6  ">
                                          <input type="color" id="colorpicker" name="color_code" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="@if(isset($data->color_code)){{$data->color_code}}@endif"> 
                                          <input type="text" name="color_code" pattern="^#+([a-fA-F0-9]{6}|[a-fA-F0-9]{3})$" value="@if(isset($data->color_code)){{$data->color_code}}@endif" id="hexcolor"></input>
