          ...
          <div class="x_content">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
               <form id="user-form" class="form-horizontal" method="post"  action="@if(!empty($data) && isset($data)){{route('suitable.store',$data->id)}}@else{{route('suitable.store')}}@endif" enctype="multipart/form-data">
                  ...
                  <fieldset>
                     <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                           <div class="x_panel">
                            <div class="x_title">
                                 <h2>@if(isset($data)){{'Edit Suitable'}}@else{{'Add Suitable'}}@endif</h2>
                              ...
                              <div class="clearfix"></div>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                       <label class="col-form-label col-md-3 col-sm-3    label-align ">Description<span class="red">*</span> </label>
                                       <div class="col-md-6 col-sm-6">
                                          <textarea class="form-control" name="short_desc" id="" cols="30" rows="6">@if(isset($data->short_desc)){{$data->short_desc}}@endif</textarea> 
                                          @if($errors->has('short_desc'))
                                          <div class="error" style="color: red">{{ $errors->first('short_desc') }}</div>
                                          @endif
                                       </div>
                                    </div>
                     ...
                     <fieldset>
                        <div class="form-group row">
                              <div class="col-md-7 col-sm-7 offset-md-5">
                                 <a href="{{route('suitable.index')}}" class="btn btn-warning">Discard</a>
