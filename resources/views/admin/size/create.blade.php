          ...
          <div class="x_content">
            ...
            <div class="tab-content" id="myTabContent">
              <div class="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
               <form id="user-form" class="form-horizontal" method="post"  action="@if(!empty($data) && isset($data)){{route('size.store',$data->id)}}@else{{route('size.store')}}@endif" enctype="multipart/form-data">
                  ...
                  <fieldset>
                     <div class="row">
                        <div class="col-md-12 col-sm-12 ">
                           <div class="x_panel">
                            <div class="x_title">
                                 <h2>@if(isset($data)){{'Edit Size'}}@else{{'Add Size'}}@endif</h2>
                              ...
                              <div class="clearfix"></div>
                                ...
                                <div class="x_content">
                                    ...
                                    <div class="item form-group">
                                        <label class="col-form-label col-md-3 col-sm-3 label-align ">Size Name<span class="red">*</span> </label>
                                        <div class="col-md-6 col-sm-6  ">
                                            <input class="form-control" type="text" value="@if(isset($data->name)){{$data->name}}@endif" placeholder="Size Name" name="name">
                                            @if($errors->has('name'))
                     ...
                     <fieldset>
                        <div class="form-group row">
                              <div class="col-md-7 col-sm-7 offset-md-5">
                                 <a href="{{route('size.index')}}" class="btn btn-warning">Discard</a>
